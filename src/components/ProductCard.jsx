...
export default function ProductCard({ product }) {
  ...
  const getWhatsAppLink = () => {
    // Clean, direct, and simple WhatsApp message
  ...
  return (
    <>
      ...
      {/* 2. THE CUSTOMIZATION MODAL (Rendered via createPortal to guarantee exact center positioning) */}
      {isModalOpen &&
        typeof document !== "undefined" &&
        createPortal(
          <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
            {/* Dull/Darkened Background Overlay */}
            <div
              ...
              <div className="w-full md:w-1/2 p-8 md:p-10 flex flex-col overflow-y-auto">
                ...
                <div className="mb-8 flex-grow">
                  ...
                  <p className="text-xs text-stone-400 mt-2">
                    *You can share reference photos with the artist once
                    WhatsApp opens.
                  </p>
                </div>
